...
mixin _$LoginFormState {
 ...
 String get email; String get password; bool get isPasswordVisible; bool get isLoading; String? get error;
...
@override
int get hashCode => Object.hash(runtimeType,email,password,isPasswordVisible,isLoading,error);

@override
String toString() {
  return 'LoginFormState(email: $email, password: $password, isPasswordVisible: $isPasswordVisible, isLoading: $isLoading, error: $error)';
}
...
@useResult
$Res call({
 String email, String password, bool isPasswordVisible, bool isLoading, String? error
});
...
/// Create a copy of LoginFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? password = null,Object? isPasswordVisible = null,Object? isLoading = null,Object? error = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  String password,  bool isPasswordVisible,  bool isLoading,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginFormState() when $default != null:
return $default(_that.email,_that.password,_that.isPasswordVisible,_that.isLoading,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  String password,  bool isPasswordVisible,  bool isLoading,  String? error)  $default,) {final _that = this;
switch (_that) {
case _LoginFormState():
return $default(_that.email,_that.password,_that.isPasswordVisible,_that.isLoading,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  String password,  bool isPasswordVisible,  bool isLoading,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _LoginFormState() when $default != null:
return $default(_that.email,_that.password,_that.isPasswordVisible,_that.isLoading,_that.error);case _:
  return null;
...
class _LoginFormState implements LoginFormState {
  const _LoginFormState({this.email = '', this.password = '', this.isPasswordVisible = false, this.isLoading = false, this.error});
...
/// Create a copy of LoginFormState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? password = null,Object? isPasswordVisible = null,Object? isLoading = null,Object? error = freezed,}) {
